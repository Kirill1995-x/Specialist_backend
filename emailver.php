...
if ($result)
{
	...
	if ($dbcode==$code)
	{
		...
		echo '<b><h3>Поздравляем! Ваш аккаунт активирован. Для начала работы с приложением необходимо убедиться, что представитель организации также перешел по ссылке.</h3></b>';
	}
	else if($dbcode==0)
	{
